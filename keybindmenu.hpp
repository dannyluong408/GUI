...
#define MOVE_BINDS 7
#define COMBAT_BINDS MOVE_BINDS+1
#define TARGET_BINDS COMBAT_BINDS+30
#define CAMERA_BINDS TARGET_BINDS+3
#define ACTION_PRIMARY_BINDS CAMERA_BINDS+10
#define ACTION_SECONDARY_BINDS ACTION_PRIMARY_BINDS+10
#define INTERFACE_BINDS ACTION_SECONDARY_BINDS+8
#define CHAT_BINDS INTERFACE_BINDS+3
#define MISC_BINDS CHAT_BINDS+1
